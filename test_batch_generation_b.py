...
def test_batch_generation_b():
    ...
    # Settings matching processing_service.py
    A4_WIDTH = 905
    A4_HEIGHT = 1280
    TARGET_HEIGHT = 244
    ...
    try:
        # Generate the single Template B image
        print(f"🔄 Generating Template B ID image...")
        ...
        # Use the same target sizes as processing_service
        ID_TARGET_W = 388
        ID_TARGET_H = 244
        GAP = 28
